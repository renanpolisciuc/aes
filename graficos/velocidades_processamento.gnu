...
set output "pdf/velocidade_processamento.pdf"
...
# título do gráfico
set title "Vazão AES - CPU/GPU - Processamento"
...
plot 'velocidades_processamento.txt' using  2:3:4:xtic(1) t "CPU" lt 2 lw 1 lc rgb "#cccc00", \
     'velocidades_processamento.txt' u 5:6:7:xtic(1) t "GPU - S" lt 2 lw 1 lc rgb "#3333cc", \
