...
set output "pdf/aceleracao_processamento.pdf"
...
# título do gráfico
set title "Aceleração - CPU/GPU - Processamento"
...
plot 'speedup_processamento.txt' u 2:3:4:xtic(1) t "GPU - S" lt 2 lw 1 lc rgb "#3333cc", \
