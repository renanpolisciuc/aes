...
set output "numero_decisoes_cenario_20_segundos.eps"	# arquivo de saida
...
set title "Número de decisões em intervalos de 20s"
...
plot '6.txt' using 2:xtic(1) t "BSR" lt 1 lc rgb "#000000" , \
