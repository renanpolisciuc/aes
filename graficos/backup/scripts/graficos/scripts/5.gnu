...
set output "numero_decisoes_cenario_15_segundos.eps"	# arquivo de saida
...
set title "Número de decisões em intervalos de 15s"
...
plot '5.txt' using 2:xtic(1) t "BSR" lt 1 lc rgb "#000000" , \
