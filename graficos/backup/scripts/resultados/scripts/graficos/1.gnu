...
set output "eps/numero_decisoes_por_cenario.eps"	# arquivo de saida
...
set title "Número de decisões por cenário"
set xlabel "Velocidade"			# legenda eixo X
set ylabel "Decisões"	# legenda eixo Y
...
plot 'dados/1.txt' using 2:xtic(1) t "Int. de decisão: 5s" lt 1 lc rgb "#1C1C1C", \
		'' u 3 t "Int. de decisão: 10s" lt 1 lc rgb "#4F4F4F", \
		'' u 4 t "Int. de decisão: 15s" lt 1 lc rgb "#828282", \
