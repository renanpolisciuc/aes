...
set output "comparacao1_15s.eps"	# arquivo de saida
...
set title "Comparação entre número de decisões e transições em intervalos de 15s"
...
plot '8_2.txt' u 2:xtic(1) t "Decisões-BSR" lt 1 lw 1.0 lc rgb "#000000", \
