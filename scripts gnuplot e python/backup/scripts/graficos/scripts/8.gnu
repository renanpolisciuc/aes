...
set output "comparacao.eps"	# arquivo de saida


set sample 25
set size 10.0,6.0	# tamanho do grafico
...
set boxwidth 1
set key inside left top horizontal spacing 2 
...
plot newhistogram "10s", '8.txt' u 2:xtic(1) t "Decisões-BSR" lt 1 lw 1.0 lc rgb "#000000", \
  ...
  newhistogram "15s", '8_2.txt' u 2:xtic(1) notitle  lt 1 lw 1.0 lc rgb "#000000", \
  ...
  newhistogram "20s", '8_3.txt' u 2:xtic(1) notitle  lt 1 lw 1.0 lc rgb "#000000", \
  '' u 3 notitle   fs pattern 1 border -1 lt -1 lw 1.0 lc rgb "#000000", \
  '' u 4 notitle  lt -1 lw 1.0 lc rgb "#626262" ,\
  '' u 5 notitle   fs pattern 4 border -1 lt -1 lw 1.0 lc rgb "#626262", \
  '' u 6 notitle  lt -1 lw 1.0 lc rgb "#B5B5B5" , \
