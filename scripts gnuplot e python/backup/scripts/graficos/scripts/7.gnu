...
set output "tempo_decisao.eps"	# arquivo de saida
...
set title "Tempo de decisão por cenário"
set xlabel "Intervalo de decisão"			# legenda eixo X
set ylabel "Tempo de decisão (milisegundos)"	# legenda eixo Y

#set auto x
set yrange [0:350]	# intervalo do eixo Y
set ytic 30			# intervalo entre os pontos do eixo Y
...
plot '7.txt' using 2:xtic(1) t "BSR" lt 1 lc rgb "#000000" , \
