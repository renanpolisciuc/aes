...
set output "eps/numero_handovers_cenario_15_segundos.eps"	# arquivo de saida
...
#set auto x
set yrange [0:10]	# intervalo do eixo Y
...
plot 'dados/4.txt' using 2:xtic(1) t "Redes sobrepostas: 2" lt 1 lc rgb "#1C1C1C", \
		'' u 3 t "Redes sobrepostas: 10" lt 1 lc rgb "#4F4F4F", \
		'' u 4 t "Redes sobrepostas: 20" lt 1 lc rgb "#828282"
