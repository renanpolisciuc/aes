...
set output "eps/numero_handovers_cenario_10_segundos.eps"	# arquivo de saida
...
#set auto x
set yrange [0:11]	# intervalo do eixo Y
...
plot 'dados/3.txt' using 2:xtic(1) t "Decisões"  fs pattern 4 lc rgb "#000000", \
